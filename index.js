...
for (let i = 0; i< question.choices.length; i++) {
  ...
  // btn.textContent = choice.label;
   ...
   btn.innerHTML = `<span class ="choice-tag">${label[i]}</span>${choice.label}`;
...
function computeVibe(totalScore) {
    ...
    emoji: "🛌",
            ...
            desc: "Comfort is your superpower. You know exactly what you like and you protect your peace fiercely. Zero"
    };
...
function restart() {
    switchScreen ("screen-quiz", "screen-start");
}
